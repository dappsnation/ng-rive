      ...
      [
        {
          path: '',
          loadChildren: () =>
            import('./file/list/list.module').then((m) => m.ListModule),
        },
        {
          path: 'player/:fileId',
          loadChildren: () =>
            import('./file/player/player.module').then((m) => m.PlayerModule),
        },
        {
          path: 'auth',
          loadChildren: () =>
        ...
        },
        {
          path: 'profile',
          loadChildren: () =>
            import('./profile/shell/shell.module').then((m) => m.ShellModule),
        },
      ],
      {
